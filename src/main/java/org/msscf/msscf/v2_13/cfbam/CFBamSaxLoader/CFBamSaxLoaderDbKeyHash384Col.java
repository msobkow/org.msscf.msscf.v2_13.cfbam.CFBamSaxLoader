...
// Description: Java 11 XML SAX Element Handler for DbKeyHash384Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash384ColObj origDbKeyHash384Col = (ICFBamDbKeyHash384ColObj)schemaObj.getDbKeyHash384ColTableObj().readDbKeyHash384ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash384Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash384Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
