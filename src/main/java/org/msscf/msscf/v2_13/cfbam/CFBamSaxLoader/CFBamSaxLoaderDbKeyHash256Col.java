...
// Description: Java 11 XML SAX Element Handler for DbKeyHash256Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash256ColObj origDbKeyHash256Col = (ICFBamDbKeyHash256ColObj)schemaObj.getDbKeyHash256ColTableObj().readDbKeyHash256ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash256Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash256Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
