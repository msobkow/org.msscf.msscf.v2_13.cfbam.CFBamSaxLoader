...
// Description: Java 11 XML SAX Element Handler for IndexTweak
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamIndexTweakObj origIndexTweak = (ICFBamIndexTweakObj)schemaObj.getIndexTweakTableObj().readIndexTweakByUNameIdx( refTenant.getRequiredId(),
