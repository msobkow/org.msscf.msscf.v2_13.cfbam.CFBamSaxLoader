...
// Description: Java 11 XML SAX Element Handler for DbKeyHash224Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash224TypeObj origDbKeyHash224Type = (ICFBamDbKeyHash224TypeObj)schemaObj.getDbKeyHash224TypeTableObj().readDbKeyHash224TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash224Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash224Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
