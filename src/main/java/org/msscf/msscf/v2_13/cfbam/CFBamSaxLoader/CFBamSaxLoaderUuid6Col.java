...
// Description: Java 11 XML SAX Element Handler for Uuid6Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamUuid6ColObj origUuid6Col = (ICFBamUuid6ColObj)schemaObj.getUuid6ColTableObj().readUuid6ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuid6Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuid6Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
