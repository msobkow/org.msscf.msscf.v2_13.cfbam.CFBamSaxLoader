...
// Description: Java 11 XML SAX Element Handler for DbKeyHash160Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash160TypeObj origDbKeyHash160Type = (ICFBamDbKeyHash160TypeObj)schemaObj.getDbKeyHash160TypeTableObj().readDbKeyHash160TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash160Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash160Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
