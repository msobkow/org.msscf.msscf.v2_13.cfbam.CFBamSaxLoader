...
// Description: Java 11 XML SAX Element Handler for DbKeyHash384Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash384TypeObj origDbKeyHash384Type = (ICFBamDbKeyHash384TypeObj)schemaObj.getDbKeyHash384TypeTableObj().readDbKeyHash384TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash384Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash384Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
