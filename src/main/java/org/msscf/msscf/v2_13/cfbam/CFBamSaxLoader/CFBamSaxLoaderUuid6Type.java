...
// Description: Java 11 XML SAX Element Handler for Uuid6Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamUuid6TypeObj origUuid6Type = (ICFBamUuid6TypeObj)schemaObj.getUuid6TypeTableObj().readUuid6TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuid6Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuid6Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
