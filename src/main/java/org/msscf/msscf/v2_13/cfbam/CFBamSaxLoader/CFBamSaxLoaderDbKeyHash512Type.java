...
// Description: Java 11 XML SAX Element Handler for DbKeyHash512Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash512TypeObj origDbKeyHash512Type = (ICFBamDbKeyHash512TypeObj)schemaObj.getDbKeyHash512TypeTableObj().readDbKeyHash512TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash512Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash512Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
