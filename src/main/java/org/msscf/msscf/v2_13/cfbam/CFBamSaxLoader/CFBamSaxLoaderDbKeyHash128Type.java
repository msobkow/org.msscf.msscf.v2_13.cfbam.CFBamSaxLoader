...
// Description: Java 11 XML SAX Element Handler for DbKeyHash128Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash128TypeObj origDbKeyHash128Type = (ICFBamDbKeyHash128TypeObj)schemaObj.getDbKeyHash128TypeTableObj().readDbKeyHash128TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash128Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash128Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
