...
// Description: Java 11 XML SAX Element Handler for Uuid6Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamUuid6DefObj origUuid6Def = (ICFBamUuid6DefObj)schemaObj.getUuid6DefTableObj().readUuid6DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuid6Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuid6Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
