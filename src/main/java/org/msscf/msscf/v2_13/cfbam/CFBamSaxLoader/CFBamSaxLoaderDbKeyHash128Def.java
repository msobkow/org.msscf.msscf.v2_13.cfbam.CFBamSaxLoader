...
// Description: Java 11 XML SAX Element Handler for DbKeyHash128Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash128DefObj origDbKeyHash128Def = (ICFBamDbKeyHash128DefObj)schemaObj.getDbKeyHash128DefTableObj().readDbKeyHash128DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash128Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash128Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
