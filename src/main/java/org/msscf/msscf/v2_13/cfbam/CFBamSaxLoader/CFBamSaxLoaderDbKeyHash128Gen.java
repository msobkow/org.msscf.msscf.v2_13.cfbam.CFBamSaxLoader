...
// Description: Java 11 XML SAX Element Handler for DbKeyHash128Gen
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash128GenObj origDbKeyHash128Gen = (ICFBamDbKeyHash128GenObj)schemaObj.getDbKeyHash128GenTableObj().readDbKeyHash128GenByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash128Gen == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash128Gen.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
						...
						editDbKeyHash128Gen.setOptionalLookupDispenser( editBuff.getOptionalLookupDispenser() );
						break;
					case Replace:
						editDbKeyHash128Gen = (ICFBamDbKeyHash128GenEditObj)origDbKeyHash128Gen.beginEdit();
