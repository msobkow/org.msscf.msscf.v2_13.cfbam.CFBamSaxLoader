...
// Description: Java 11 XML SAX Element Handler for DbKeyHash512Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash512ColObj origDbKeyHash512Col = (ICFBamDbKeyHash512ColObj)schemaObj.getDbKeyHash512ColTableObj().readDbKeyHash512ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash512Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash512Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
