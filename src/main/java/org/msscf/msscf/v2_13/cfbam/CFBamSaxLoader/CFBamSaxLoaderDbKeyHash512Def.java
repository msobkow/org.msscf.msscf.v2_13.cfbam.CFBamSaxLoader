...
// Description: Java 11 XML SAX Element Handler for DbKeyHash512Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash512DefObj origDbKeyHash512Def = (ICFBamDbKeyHash512DefObj)schemaObj.getDbKeyHash512DefTableObj().readDbKeyHash512DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash512Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash512Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
