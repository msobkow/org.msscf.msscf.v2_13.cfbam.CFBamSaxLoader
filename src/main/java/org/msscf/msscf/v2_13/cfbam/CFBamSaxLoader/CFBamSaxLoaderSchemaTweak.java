...
// Description: Java 11 XML SAX Element Handler for SchemaTweak
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamSchemaTweakObj origSchemaTweak = (ICFBamSchemaTweakObj)schemaObj.getSchemaTweakTableObj().readSchemaTweakByUNameIdx( refTenant.getRequiredId(),
