...
// Description: Java 11 XML SAX Element Handler for DbKeyHash128Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash128ColObj origDbKeyHash128Col = (ICFBamDbKeyHash128ColObj)schemaObj.getDbKeyHash128ColTableObj().readDbKeyHash128ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash128Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash128Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
