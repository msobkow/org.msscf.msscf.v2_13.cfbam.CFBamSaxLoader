...
// Description: Java 11 XML SAX Element Handler for DbKeyHash384Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash384DefObj origDbKeyHash384Def = (ICFBamDbKeyHash384DefObj)schemaObj.getDbKeyHash384DefTableObj().readDbKeyHash384DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash384Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash384Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
