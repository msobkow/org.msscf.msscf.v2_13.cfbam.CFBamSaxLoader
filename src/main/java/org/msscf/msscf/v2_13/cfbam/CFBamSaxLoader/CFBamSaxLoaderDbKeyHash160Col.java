...
// Description: Java 11 XML SAX Element Handler for DbKeyHash160Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash160ColObj origDbKeyHash160Col = (ICFBamDbKeyHash160ColObj)schemaObj.getDbKeyHash160ColTableObj().readDbKeyHash160ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash160Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash160Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
