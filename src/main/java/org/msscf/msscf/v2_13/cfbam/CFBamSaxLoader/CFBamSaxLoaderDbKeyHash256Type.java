...
// Description: Java 11 XML SAX Element Handler for DbKeyHash256Type
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash256TypeObj origDbKeyHash256Type = (ICFBamDbKeyHash256TypeObj)schemaObj.getDbKeyHash256TypeTableObj().readDbKeyHash256TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash256Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash256Type.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
