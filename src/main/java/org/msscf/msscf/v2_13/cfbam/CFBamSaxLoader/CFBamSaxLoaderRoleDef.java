...
// Description: Java 11 XML SAX Element Handler for RoleDef
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamRoleDefObj origRoleDef = (ICFBamRoleDefObj)schemaObj.getRoleDefTableObj().readRoleDefByUNameIdx( refTenant.getRequiredId(),
