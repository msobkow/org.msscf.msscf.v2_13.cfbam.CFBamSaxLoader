...
// Description: Java 11 XML SAX Element Handler for DbKeyHash256Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash256DefObj origDbKeyHash256Def = (ICFBamDbKeyHash256DefObj)schemaObj.getDbKeyHash256DefTableObj().readDbKeyHash256DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash256Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash256Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
