...
// Description: Java 11 XML SAX Element Handler for DbKeyHash224Col
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash224ColObj origDbKeyHash224Col = (ICFBamDbKeyHash224ColObj)schemaObj.getDbKeyHash224ColTableObj().readDbKeyHash224ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash224Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash224Col.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
