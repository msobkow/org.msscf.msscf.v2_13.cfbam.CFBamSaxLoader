...
// Description: Java 11 XML SAX Element Handler for DbKeyHash160Def
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamDbKeyHash160DefObj origDbKeyHash160Def = (ICFBamDbKeyHash160DefObj)schemaObj.getDbKeyHash160DefTableObj().readDbKeyHash160DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDbKeyHash160Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDbKeyHash160Def.setRequiredCodeVis( editBuff.getRequiredCodeVis() );
